...
export const quickNewStubbedAgenda: EventAgenda = {
  ...
  schedule: [
    ...
    {
      title: "Main Session",
      startDate: addSeconds(baseTime, 6),
      endDate: addSeconds(baseTime, 20),
    ...
    {
      title: "Main Session",
      startDate: addSeconds(baseTime, 20),
      endDate: addSeconds(baseTime, 30),
    ...
    {
      title: "Main Session",
      startDate: addSeconds(baseTime, 30),
      endDate: addSeconds(baseTime, 40),
    ...
    },
    {
      ...
      startDate: addSeconds(baseTime, 40),
...
export const newStubbedAgenda: EventAgenda = {
  heading: "The Future of Go-to-Market Starts Here",
  subheading:
    "Join ZoomInfo's flagship virtual conference for AI-driven strategies and cutting-edge insights that help sales, marketing, and RevOps teams stay ahead in a competitive market.",
  schedule: [
    {
      title: "Keynote",
      startDate: new Date("2025-05-07T18:00:00.000+00:00"),
      endDate: new Date("2025-05-07T19:00:00.000+00:00"),
      eventId: "55ff41fa-55ff-4bf5-8012-1190dac93cb9",
      url: "https://www.zoominfo.com/live/gtm25-keynote",
      supheading: "Henry Schuck, CEO & Founder ZoomInfo",
      heading: "The Future of AI-Driven Go-To-Market Intelligence",
    ...
    {
      title: "Main Session",
      startDate: new Date("2025-05-07T18:30:00.000+00:00"),
      endDate: new Date("2025-05-07T19:00:00.000+00:00"),
      eventId: "8ea595c1-99df-4609-a475-fbc351935b54",
      url: "https://www.zoominfo.com/live/gtm25-ai-b2b-sales",
      supheading: "Todd Horst, Partner McKinsey & Company",
    ...
    {
      title: "Main Session",
      startDate: new Date("2025-05-07T19:00:00.000+00:00"),
      endDate: new Date("2025-05-07T19:30:00.000+00:00"),
      eventId: "91eb98d4-6cb9-4a91-ada0-8344d66a084f",
      url: "https://www.zoominfo.com/live/gtm25-intelligence-platform",
      supheading: "Dominik Facher, CPO ZoomInfo",
      heading: "Go-To-Market Intelligence Platform Reveal",
    ...
    {
      title: "Main Session",
      startDate: new Date("2025-05-07T19:30:00.000+00:00"),
      endDate: new Date("2025-05-07T20:00:00.000+00:00"),
      eventId: "988e550e-b3be-4fc4-b659-6782cd70f9a2",
      url: "https://www.zoominfo.com/live/gtm25-revenue-growth",
      supheading: "James Roth, CRO ZoomInfo",
      heading: "The Future of Revenue Growth",
    ...
    {
      title: "Breakout Session 1",
      startDate: new Date("2025-05-07T20:00:00.000+00:00"),
...
export const getEvent = async (eventId: string): Promise<Event> => {
  ...
  if (newStubbedAgenda.schedule.some((item) => item.eventId === eventId)) {
    return {
      ...data,
      agenda: window.IS_STORYBOOK ? quickNewStubbedAgenda : newStubbedAgenda,
    };
  }
