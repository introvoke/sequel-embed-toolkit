...
export const newStubbedAgenda: EventAgenda = {
  ...
  schedule: [
    ...
    {
      title: "Main Session",
      startDate: addMinutes(baseTime, 2),
      endDate: addMinutes(baseTime, 3),
    ...
    {
      title: "Main Session",
      startDate: addMinutes(baseTime, 3),
      endDate: addMinutes(baseTime, 4),
    ...
    },
    {
      ...
      startDate: addMinutes(baseTime, 4),
      endDate: addMinutes(baseTime, 5),
